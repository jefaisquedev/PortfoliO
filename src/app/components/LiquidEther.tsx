...
`;
    ...
    type ShaderPassProps = {
      material?: { vertexShader: string; fragmentShader: string; uniforms: Record<string, THREE.IUniform> };
    ...
    class ExternalForce extends ShaderPass {
      mouse!: THREE.Mesh<THREE.PlaneGeometry, THREE.RawShaderMaterial>;
    ...
    class Output {
      ...
      scene!: THREE.Scene;
      camera!: THREE.Camera;
      output!: THREE.Mesh<THREE.PlaneGeometry, THREE.RawShaderMaterial>;
